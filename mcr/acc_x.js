        ...
        return new Promise((resolve, reject) => {
            db.getConnection((err, connection) => {
                ...
                connection.beginTransaction(err => {
                    ...
                    executeQueries(connection, quantity, check2fa, cookie, day, shop, live)
                        .then(result => {
    ...
    return new Promise((resolve, reject) => {
        ...
        connection.query(productQuery, [quantity], (error, results) => {
            ...
            if (results.length === 0) {
                ...
                const updateQuery = `UPDATE mcr_x SET status = 'AccBanTay${shop}', sold_date = CURDATE() WHERE id IN (?)`;
